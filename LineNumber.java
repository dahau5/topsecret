	...
	public LineNumber nextlinenumber_helper(String op, Expression provenExpr, String previousline){
		...
		if (op.equals("show")) {
			...
			if (Proof.myLineNumbers.size() == 1) {
				try{
					Proof.firstShow = new Expression(provenExpr.myname); // First occurence of show and expression
		...
		if ((op.equals("ic") || op.equals("mp") || op.equals("co") || op.equals("mt")) && provenExpr.equals(Proof.expr.lastElement())) {
